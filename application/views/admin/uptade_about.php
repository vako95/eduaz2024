...
<div class="row">
    ...
    <?php $get_all_news_title = json_decode($get_single_about['b_title'], TRUE);  ?>
    <?php $get_all_news_description = json_decode($get_single_about['b_description'], TRUE);  ?>
    <form action="<?php echo base_url('update_about_act/' . $get_single_about['b_id']); ?>" method="post" enctype="multipart/form-data" class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
        ...
        <div class="col-xs-6 col-md-3 col-lg-3 col-sm-3" style="float: left; margin:0px 25px;">
            ...
            <select name="cate" class="form-control" id="cate">
                <option <?php if ($get_single_about['b_category'] == "") {
                            echo "SELECTED";
                        } ?> value="">-Select-</option>
                <option <?php if ($get_single_about['b_category'] == "Web") {
                            echo "SELECTED";
                        } ?> value="Web">Web Desing</option>
                <option <?php if ($get_single_about['b_category'] == "Craphic") {
                            echo "SELECTED";
                        } ?> value="Craphic">Craphic Design</option>
                <option <?php if ($get_single_about['b_category'] == "Video") {
                            echo "SELECTED";
                        } ?> value="Video">Video Editing</option>
                <option <?php if ($get_single_about['b_category'] == "Online") {
                            echo "SELECTED";
        ...
        <div class="col-xs-6 col-md-3 col-lg-3 col-sm-3" style="float: left;">
            <div class="row">
                ...
                <select name="status" class="form-control" id="status">
                    <option <?php if ($get_single_about['b_status'] == "") {
                                echo "SELECTED";
                            } ?> value="">-Select-</option>
                    <option <?php if ($get_single_about['b_status'] == "Active") {
                                echo "SELECTED";
                            } ?> value="Active">Active</option>
                    <option <?php if ($get_single_about['b_status'] == "Deactive") {
                                echo "SELECTED";
