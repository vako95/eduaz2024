    ...
    <div class="col-md-12 col-lg-12 col-sm-12">
        <div class="white-box">
            <div class="d-md-flex mb-3">
                <h3 style="color:red;" class="box-title mb-0">News Experts</h3>

                <div class="col-md-3 col-sm-4 col-xs-6 ms-auto">
                    <a href="<?php echo base_url('admin_creat_experts'); ?>">
                        ...
                        <?php foreach ($all_expert as $all_expert_key) { ?>
                            ...
                            <tr>
                                ...
                                <td> <?php if ($all_expert_key['e_img']) { ?>
                                        <img style="width: 50px; height:50px; object-fit:cover;" src="<?php echo base_url('uploads/news/' . $all_expert_key['e_img']); ?>" alt="">
                                    <?php  } else { ?>
                                        <img style="width: 50px; height:50px; object-fit:cover;" src="public/admin/assets/img/aviable.png" alt="">
                                    <?php } ?>
                                </td>

                                <td> <?php echo $all_expert_key['e_status']; ?></td>
                                ...
                                <td>
                                    ...
                                    <a class="btn-hapus"  href="<?php echo base_url('delete_experts/' .$all_expert_key['e_id']) ?>">
