...
<div class="row">
    ...
    <div class="white-box">
        ...
        <form action="<?php echo base_url('admin_about_act'); ?>" method="post" enctype="multipart/form-data" class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
            ...
            <p><?php echo $get_single_about['b_title']; ?></p>
    </div>
    <br>
    <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
        <label for="mytextarea">Description</label>

        <p><?php echo $get_single_about['b_description']; ?></p>
    ...
    <img class="img-fluid img_slider " src="<?php echo base_url('uploads/news/' . $get_single_about['b_img']); ?>" alt="">
<?php } else { ?>
...
<?php } ?>
    ...
    <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12" style="float:left;">
        <div class="row">
            <br>
            <br>
            <a href="<?php echo base_url('admin_about_skilled'); ?>">
