            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="<?php echo base_url('experts_single/11') ?>">sTIMUL</a>, 
                        ...
                        <?php echo $this->lang->line('distributed by'); ?> <a class="border-bottom" href="<?php echo base_url('experts_single/11') ?>">ThemeWagon</a>
                    </div>
                    <div class="col-md-6 text-center text-md-end">
                        <div class="footer-menu">
                            <a href="<?php echo base_url('index') ?>"><?php echo $this->lang->line('home'); ?></a>
